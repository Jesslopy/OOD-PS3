...
public class NorthSpringsLibrary
{
    ...
    public static void main(String[] args)
	{
		...
		Book b1 = new Book("Designing with Objects", 0, 1);
		bookCirculation.put(0, b1.saveState());
		b1 = new Book("Designing with Objects", 1, 3);	
		bookCirculation.put(1, b1.saveState());
		b1 = new Book("Designing with Objects", 2, 5);	
		bookCirculation.put(2, b1.saveState());
		b1 = new Book("Designing with Objects", 3, 0);	
		bookCirculation.put(3, b1.saveState());
		b1 = new Book("Designing with Objects", 4, 2);	
		...
		Book b2 = new Book("C++ for Beginners", 0, 0);
		bookCirculation.put(0, b2.saveState());
		b2 = new Book("C++ for Beginners", 1, 0);	
